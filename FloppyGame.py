...
FONT = pygame.font.SysFont('Verdena', 20)
...
player_rect = player.get_rect(center=(WIDTH/10, HEIGHT/2))
...
def create_enemy():
	...
	enemy_rect = pygame.Rect(WIDTH, random.randint(80, 720), *enemy_size)
...
def create_bonus():
	...
	bonus_rect = pygame.Rect(random.randint(50, 1100), 0, *bonus_size)
...
while playing:
	...
	for event in pygame.event.get():
		...
		if event.type == CREATE_BONUS and len(bonuses) < max_bonuses:
